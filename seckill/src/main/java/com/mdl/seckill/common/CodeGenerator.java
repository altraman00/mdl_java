package com.mdl.seckill.common;
...
/**
 * @Project : java
 * @Package Name : com.mdl.seckill.common.generator
 * @Description : 执行 main 方法控制台输入模块表名回车自动生成对应项目目录中
 * @Author : xiekun
 * @Create Date : 2020年12月22日 15:18
 * ----------------- ----------------- -----------------
 */
public class CodeGenerator {
  ...
  public final static String packageName = "com.mdl.seckill";
