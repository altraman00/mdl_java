...
import com.mdl.influxdb2.demo.model.LocationWithDescription;
...
public class QueryBuilderSelectDemo {

  private static final Logger LOGGER = Logger.getLogger(QueryBuilderSelectDemo.class.getName());
  ...
  private static final void selectAll(InfluxDBMapper influxDBMapper) {
    ...
    List<H2OFeetMeasurement> h2OFeetMeasurements = influxDBMapper
        .query(query, H2OFeetMeasurement.class);
  }
  ...
  private static final void selectGreater(InfluxDBMapper influxDBMapper) {
    ...
    List<H2OFeetMeasurement> higherThanMeasurements = influxDBMapper
        .query(query, H2OFeetMeasurement.class);
  }
  ...
  private static final void selectFields(InfluxDBMapper influxDBMapper) {
    ...
    List<LocationWithDescription> locationWithDescriptions = influxDBMapper
        .query(selectFields, LocationWithDescription.class);
  }
