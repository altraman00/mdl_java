package com.mdl.file.pointupload.utils;
...
/**
 * @Project : mdl-demo
 * @Package Name : com.mdl.file.pointupload.utils
 * @Description : TODO
 * @Author : xiekun
 * @Create Date : 2020年10月20日 15:55
 * ----------------- ----------------- -----------------
 */
@Component
...
//  @Value("${yakir.upload.dir}")
  private String finalDirPath = "/Users/knight/Desktop/mobvoi/pic/";
