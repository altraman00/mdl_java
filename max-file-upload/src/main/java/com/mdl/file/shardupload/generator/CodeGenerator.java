...
public class CodeGenerator {
   ...
   * 数据库配置
   */
  public final static String db_datasource_url = "jdbc:mysql://127.0.0.1:3306/mcloud?useUnicode=true&useSSL=false&characterEncoding=utf8";
